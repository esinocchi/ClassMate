...
def create_extensive_test_json(file_path: Path, user_id="extensive_test_user_456") -> str:
    ...
    course_subjects = [
        {"id": "3000000", "name": "Computer Science Fundamentals", "code": "CS101", "subject": "computer science"},
        {"id": "3000001", "name": "Advanced Data Structures", "code": "CS201", "subject": "algorithms"},
        {"id": "3000002", "name": "Database Systems", "code": "CS301", "subject": "databases"},
        {"id": "3000003", "name": "Machine Learning Basics", "code": "ML101", "subject": "machine learning"},
        {"id": "3000004", "name": "Web Development", "code": "WEB201", "subject": "web development"},
        {"id": "3000005", "name": "Software Engineering", "code": "SE301", "subject": "software engineering"},
        {"id": "3000006", "name": "Calculus I", "code": "MATH101", "subject": "mathematics"},
        {"id": "3000007", "name": "Statistics and Probability", "code": "STAT201", "subject": "statistics"},
        {"id": "3000008", "name": "Physics I", "code": "PHYS101", "subject": "physics"},
        {"id": "3000009", "name": "Technical Writing", "code": "ENG301", "subject": "writing"}
    ]
    ...
    assignment_templates = [
        {"type": "homework", "names": ["Homework", "Problem Set", "Exercise", "Practice"], "descriptions": ["Complete the assigned problems", "Solve the given exercises", "Work through the practice problems"]},
        {"type": "lab", "names": ["Lab", "Laboratory", "Practical"], "descriptions": ["Complete the lab assignment", "Perform the laboratory exercise", "Finish the practical work"]},
        {"type": "project", "names": ["Project", "Final Project", "Group Project"], "descriptions": ["Complete the project requirements", "Develop the assigned project", "Build the required application"]},
        {"type": "quiz", "names": ["Quiz", "Short Quiz", "Weekly Quiz"], "descriptions": ["Take the quiz on course material", "Complete the assessment", "Answer the quiz questions"]},
        {"type": "exam", "names": ["Exam", "Midterm", "Final Exam"], "descriptions": ["Take the examination", "Complete the test", "Finish the assessment"]}
    ]
    ...
    file_templates = [
        {"type": "lecture", "names": ["Lecture Notes", "Slides", "Presentation"], "extensions": [".pdf", ".pptx"]},
        {"type": "reading", "names": ["Reading Material", "Chapter", "Article"], "extensions": [".pdf", ".docx"]},
        {"type": "code", "names": ["Code Example", "Sample Code", "Template"], "extensions": [".py", ".java", ".cpp"]},
        {"type": "data", "names": ["Dataset", "Data File", "Sample Data"], "extensions": [".csv", ".json", ".xlsx"]}
    ]
    ...
    for course in course_subjects:
        ...
        for i in range(num_files):
            ...
            files.append({
                ...
                "updated_at": (base_date + timedelta(days=random.randint(1, 100))).strftime("%Y-%m-%dT12:00:00Z"),
                "locked": False,
    ...
    for course in course_subjects:
        ...
        for i in range(num_announcements):
            ...
            message = template.format(
                ...
                assignment_type=random.choice(["Assignment", "Homework", "Lab", "Project"]),
    ...
    for course in course_subjects:
        ...
        for i in range(num_events):
            ...
            start_time = start_date.replace(hour=random.randint(9, 16), minute=random.choice([0, 30]))
    ...
    quiz_id = 60000000
    quiz_templates = [
        {"title": "Weekly Quiz", "type": "practice_quiz", "time_limit": 30, "points": 10},
        {"title": "Chapter Review", "type": "assignment", "time_limit": 45, "points": 25},
        {"title": "Midterm Exam", "type": "assignment", "time_limit": 90, "points": 100},
    ...
    for course in course_subjects:
        ...
        for i in range(num_quizzes):
            ...
            quizzes.append({
                ...
                "lock_explanation": "This quiz was locked after the due date." if random.choice([True, False]) else None,
                "module_id": 5479590 + i,
    ...
    print(f"Generated extensive test data:")
    ...
    print(f"  - Total documents: {len(courses) + len(assignments) + len(files) + len(announcements) + len(calendar_events) + len(quizzes)}")
...
def generate_test_search_queries() -> List[Dict[str, Any]]:
    ...
    course_ids = ["3000000", "3000001", "3000002", "3000003", "3000004", 
                  "3000005", "3000006", "3000007", "3000008", "3000009"]
    ...
    assignment_queries = [
        "homework assignment", "lab assignment", "project assignment", "final project",
        "programming assignment", "math homework", "physics lab", "writing assignment",
        "group project", "individual assignment", "weekly homework", "problem set",
        "exercise assignment", "practical work", "coding project", "research project",
        "data analysis", "algorithm implementation", "database design", "web development"
    ]
    ...
    file_queries = [
        "lecture notes", "slides presentation", "reading material", "code example",
        "dataset file", "sample code", "chapter reading", "lecture slides",
        "programming template", "data file", "course materials", "study guide",
        "reference document", "sample data", "code template"
    ]
    ...
    quiz_queries = [
        "weekly quiz", "midterm exam", "final exam", "chapter review",
        "practice quiz", "pop quiz", "assessment", "test",
        "examination", "quiz review"
    ]
    ...
    event_queries = [
        "lecture schedule", "lab session", "office hours", "study group",
        "exam schedule", "presentation", "class meeting", "tutorial",
        "workshop", "seminar"
    ]
    ...
    cross_course_queries = [
        "programming assignments", "mathematics concepts", "project work",
        "exam schedules", "lecture materials", "lab sessions",
        "homework assignments", "study materials", "course updates",
        "final projects"
    ]
    ...
    specific_date_queries = [
        ...
        {"query": "events between 2024-11-01 and 2024-11-30", "dates": ["2024-11-01", "2024-11-30"]},
        ...
        {"query": "assignments between 2024-09-01 and 2024-09-15", "dates": ["2024-09-01", "2024-09-15"]},
    ...
    for i, date_query in enumerate(specific_date_queries):
        ...
        search_queries.append({
            "search_parameters": {
                ...
                "keywords": [word for word in date_query["query"].split() if not any(char.isdigit() for char in word)],
    ...
    keyword_searches = [
        ...
        {"query": "lecture notes and slides", "keywords": ["lecture", "notes", "slides"]},
