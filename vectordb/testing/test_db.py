...
QDRANT_LOCAL_STORAGE_URL_DIRNAME = "https://2defb98f-e5e4-430a-b167-6144588cc5c2.us-east4-0.gcp.cloud.qdrant.io:6333"
...
async def test_search_vectors_extensive(db_instance: VectorDatabase) -> None:
    ...
    try:
        ...
        for i, query_data in enumerate(search_queries):
            result_summary = await perform_single_search(
                extensive_db, query_data, i
            )
        ...
        print(f"✅ Extensive search test completed successfully!")
        ...
        try:
            ...
            print(f"Successfully deleted extensive test collection: "
                  f"{extensive_db.collection_name}")
        except Exception as e:
            print(f"Warning: Error deleting extensive test collection "
