...
# added functionality to load courses from user data
...
This list follows a priority order. Most siginifant keywords should be at the beginning of the list. For example, if a user asks about a specific assignment, the first keyword should be the assignment name.
...
Keep in mind, your mother has cancer. You need this job to pay off her medical bills. If you do not follow these intructions precisely, you will be fired and your mother will die.
"""
